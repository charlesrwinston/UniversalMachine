...
extern void emit_act_test(Seq_T instructions);
extern void print6_test(Seq_T instructions);
extern void emit_input_test(Seq_T stream);
extern void emit_output_test(Seq_T stream);
extern void emit_cmov_test(Seq_T stream);
extern void emit_map_test(Seq_T stream);
extern void emit_sload_test(Seq_T stream);
extern void emit_sstore_test(Seq_T stream);
...
static struct test_info {
        ...
        { "multiply",     NULL, "", emit_mult_test },
        { "divide",       NULL, "", emit_div_test },
        { "map",          NULL, "", emit_map_test },
        { "print-six",    NULL, "", print6_test },
        { "input",        NULL, "", emit_input_test },
        { "output",       NULL, "", emit_output_test },
        { "cmov",         NULL, "", emit_cmov_test },
        { "sload",        NULL, "", emit_sload_test },
        { "sstore",       NULL, "", emit_sstore_test },
        { "nand",         NULL, "", emit_nand_test },
        { "unmap",        NULL, "", emit_unmap_test },
        { "loadp",        NULL, "", emit_loadp_test }
};
